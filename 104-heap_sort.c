...
/**
 * swap - utility function to exchange integers
 * @a: integer a variable
 ...
 * @idx: index variable
 * @n: variable for size of the array to run
 */
...
/**
 * heap_sort -  function for sorting a given array size
 * @array: array to sort variable
